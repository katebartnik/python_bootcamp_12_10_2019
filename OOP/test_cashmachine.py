...
def test_cash_machine_put_money():
    ...
    assert cash_machine.bills == [200, 100, 100, 50]
    assert cash_machine.is_available is True
    cash_machine.put_money([200, 100])
    assert cash_machine.bills == [200, 100, 100, 50, 200, 100]
...
def test_withdraw_money_2():
    ...
    # [50,50,50,100,100]
    assert cash_machine.bills == [100, 50, 200]
    assert cash_machine.withdraw_money(200) == [200]
    assert cash_machine.bills == [100, 50]
...
def test_withdraw_money_3():
    ...
    assert cash_machine.bills == [50, 50, 50]
